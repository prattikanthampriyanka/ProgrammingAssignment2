...
# [TIPS] Demystifying makeVector() Pinned Post above 
 # be sure to do so.
...
[2,] -0.25  0.75
 ...
 # comments in sufficient detail to show you
 # understand how they work, and on submitting the 
 # web address of your GitHub repository for this
 # assignment, and on submitting the 40 character
 # SHA-1 hash code for your final cachematrix.R commit,
 # using this (or some other)   
